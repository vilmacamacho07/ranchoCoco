@extends('theme.'.$theme.'.layout')
    @section('title')
             Rancho Los Cocos- Insertar Ganado
    @endsection
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Insertar Medicina</h3>
                    ...
                    <form method="POST" action="{{route('guardar_medicina')}}"  id="form-general" class="form-horizontal" autocomplete="off">
                        @csrf
                        <div class="card-body" >
